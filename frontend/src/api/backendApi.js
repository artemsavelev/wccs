...
export default {
    ...
    API_DEVICE_TO_SET_URL: API_BASE_URL + 'device/addToSet',
    API_MATERIAL_URL: API_BASE_URL + 'material/',
    API_MATERIAL_TO_SET_URL: API_BASE_URL + 'material/addToSet',
    API_WORK_URL: API_BASE_URL + 'work/',
    API_WORK_TO_SET_URL: API_BASE_URL + 'work/addToSet',
